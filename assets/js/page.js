(function() {
   ...
   * Mobile nav toggle
   */
  const mobileNavToggleBtn = document.querySelector('.nav-toggle');

  function mobileNavToogle() {
    document.querySelector('#header').classList.toggle('navmenu-show');
  ...
  /**
   * Update header class based on window width
   */
  function headerClassUpdate() {
    if (window.innerWidth > 767) {
      document.querySelector('#header').classList.remove('flex-column');
      document.querySelector('#header').classList.add('align-items-center');
      document.querySelector('#header').classList.add('sticky-top');
    } else {
      document.querySelector('#header').classList.remove('align-items-center');
      document.querySelector('#header').classList.add('flex-column');
      document.querySelector('#header').classList.remove('sticky-top');
    }
  }
  window.addEventListener('resize', headerClassUpdate);
  mobileNavToggleBtn.addEventListener('click', headerClassUpdate);
  ...
  document.querySelectorAll('#navmenu a').forEach(navmenu => {
    navmenu.addEventListener('click', () => {
      if (document.querySelector('.navmenu-show')) {
        mobileNavToogle();
      }
    });
  });
